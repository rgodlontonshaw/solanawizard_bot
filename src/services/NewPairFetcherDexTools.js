//TODO put same info on the bot for token metadata // use the price fetcher to then retrieve the data for the price /liquidy of the token. at least liquidity..
